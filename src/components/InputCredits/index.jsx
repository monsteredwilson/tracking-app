...
export function InputCredits() {
	...
	if (targetButton == 'pack-starter') {
		...
		00005303986540515.005802BR5925IARA-INDUSTRIA-E-COMERCIO
		6007GUARUJA62150511PACKSTARTER6304BBE4`
		buttonCopyText = `00020126580014BR.GOV.BCB.PIX0136db9598e9-dd03-4253-bb56-0a7931a85847520400005303986540515.005802BR5925IARA-INDUSTRIA-E-COMERCIO6007GUARUJA62150511PACKSTARTER6304BBE4`
	} else if (targetButton == 'pack-bronze') {
		imgPix = packBronzeImage
		textPix = `00020126580014BR.GOV.BCB.PIX0136db9
		598e9-dd03-4253-bb56-0a7931a858475204
		000053039865406125.005802BR5925IARA-INDUSTRIA-E-COMERCIO
		6007GUARUJA62140510PACKBRONZE6304B7D9`
		buttonCopyText = `00020126580014BR.GOV.BCB.PIX0136db9598e9-dd03-4253-bb56-0a7931a858475204000053039865406125.005802BR5925IARA-INDUSTRIA-E-COMERCIO6007GUARUJA62140510PACKBRONZE6304B7D9`
	} else if (targetButton == 'pack-prata') {
		imgPix = packPrataImage
		textPix = `00020126580014BR.GOV.BCB.PIX0136db9
		598e9-dd03-4253-bb56-0a7931a858475204
		000053039865406500.005802BR5925IARA-INDUSTRIA-E-COMERCIO
		6007GUARUJA62130509PACKPRATA630405DD`
		buttonCopyText = `00020126580014BR.GOV.BCB.PIX0136db9598e9-dd03-4253-bb56-0a7931a858475204000053039865406500.005802BR5925IARA-INDUSTRIA-E-COMERCIO6007GUARUJA62130509PACKPRATA630405DD`
	} else if (targetButton == 'pack-ouro') {
		imgPix = packOuroImage
		textPix = `00020126580014BR.GOV.BCB.PIX0136db9
		598e9-dd03-4253-bb56-0a7931a858475204
		000053039865406900.005802BR5925IARA-INDUSTRIA-E-COMERCIO
		6007GUARUJA62120508PACKOURO6304B9F6`
		buttonCopyText = `00020126580014BR.GOV.BCB.PIX0136db9598e9-dd03-4253-bb56-0a7931a858475204000053039865406900.005802BR5925IARA-INDUSTRIA-E-COMERCIO6007GUARUJA62120508PACKOURO6304B9F6`
	} else if (targetButton == 'pack-platina') {
		imgPix = packPlatinaImage
		textPix = `00020126580014BR.GOV.BCB.PIX0136db9
		598e9-dd03-4253-bb56-0a7931a858475204
		0000530398654071500.005802BR5925IARA-INDUSTRIA-E-COMERCIO
		6007GUARUJA62150511PACKPLATINA63049A6D`
		buttonCopyText = `00020126580014BR.GOV.BCB.PIX0136db9598e9-dd03-4253-bb56-0a7931a8584752040000530398654071500.005802BR5925IARA-INDUSTRIA-E-COMERCIO6007GUARUJA62150511PACKPLATINA63049A6D`
	} else if (targetButton == 'pack-diamante') {
		imgPix = packDiamanteImage
		textPix = `00020126580014BR.GOV.BCB.PIX0136db9
		598e9-dd03-4253-bb56-0a7931a858475204
		0000530398654073000.005802BR5925IARA-INDUSTRIA-E-COMERCIO
		6007GUARUJA62160512PACKDIAMANTE6304BF9B`
		buttonCopyText = `00020126580014BR.GOV.BCB.PIX0136db9598e9-dd03-4253-bb56-0a7931a8584752040000530398654073000.005802BR5925IARA-INDUSTRIA-E-COMERCIO6007GUARUJA62160512PACKDIAMANTE6304BF9B`
	}
